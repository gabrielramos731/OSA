...
set<string> CarregarStopWords(const string &arq){
...
// Função de filtragem
string removerStopwords(const string &texto, const set<string> &stopwords) {
...
int main() {
    set<string> stopwords = CarregarStopWords("stopwords_en.txt");
